<div class="w-1/2 md:w-1/3 lg:w-1/4">
	<!-- Tailwind CSS: card con aspect ratio quadrato per anteprima video -->
	<a class="pg_video relative block h-full w-full overflow-hidden rounded-lg x_adslist aspect-square" href="{$system['system_url']}/{if $_is_reel}reels{else}posts{/if}/{$video['post_id']}">
		...
		<!-- Tailwind CSS: overlay centrale con pulsante play -->
		<div class="play-button absolute flex items-center justify-center rounded-full bg-black/80 text-white">
