				...
				<div class="d-flex align-items-center justify-content-center">
					{if $user->_data['can_boost_posts'] || $user->_data['can_boost_pages'] || $user->_data['can_boost_groups'] || $user->_data['can_boost_events']}
						...
						{if $system['groups_enabled']}
							<div>
								<a href="{$system['system_url']}/boosted/groups" class="body-color side_item_hover w-100 text-center d-block">
						...
						{if $system['events_enabled']}
							<div>
								<a href="{$system['system_url']}/boosted/events" class="body-color side_item_hover w-100 text-center d-block">
