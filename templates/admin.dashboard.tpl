        ...
        <div class="col-lg-4">
          <div class="stat-panel bg-gradient-warning">
            <div class="stat-cell narrow">
              ...
              <span class="text-lg">{__("Pending")}</span><br>
              <a href="{$system['system_url']}/{$control_panel['url']}/users/pending">{__("Manage Pending")}</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="stat-panel bg-gradient-danger">
            <div class="stat-cell narrow">
              ...
              <a href="{$system['system_url']}/{$control_panel['url']}/users/not_activated">{__("Manage Not Activated")}</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
      ...
      <div class="col-lg-4">
        <div class="stat-panel bg-gradient-gray">
          <div class="stat-cell narrow">
            ...
            <span class="text-xxlg">{$insights['vistors']}</span><br>
            <span class="text-lg">{__("Total Visits")}</span><br>
          </div>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="stat-panel bg-gradient-gray">
          <div class="stat-cell narrow">
            <i class="fa fa-clipboard-user bg-icon"></i>
            <span class="text-xxlg">{$insights['vistors_today']}</span><br>
            <span class="text-lg">{__("Today Visits")}</span><br>
          </div>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="stat-panel bg-gradient-gray">
          <div class="stat-cell narrow">
            <i class="fa fa-clipboard-user bg-icon"></i>
            <span class="text-xxlg">{$insights['vistors_month']}</span><br>
            <span class="text-lg">{__("This Month Visits")}</span><br>
          </div>
        </div>
      </div>
    </div>
