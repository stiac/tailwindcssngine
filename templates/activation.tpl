...
<div class="row x_content_row">
    <div class="col-lg-12 w-100">
		<div class="p-3 py-md-5 text-center">
			...
			<h4 class="headline-font">{__("Hey")} 👋 {__("Let's verify your")} {if $system['activation_type'] == "email"}{__("email")}{else}{__("phone")}{/if}</h4>
			<p class="">
			...
			<div class="mt-4 d-flex align-items-center justify-content-center gap-2 flex-wrap">
				{if $system['activation_type'] == "email"}
					<button type="button" class="btn btn-success" data-toggle="modal" data-url="#activation-email">{__("Enter Code")}</button>
					<button type="button" class="btn btn-primary" data-toggle="modal" data-url="core/activation_email_resend.php">
						{__("Resend Email")}
					</button>
