			...
			<div class="col-lg-6">
				<div class="stat-panel bg-success bg-opacity-10">
					<div class="stat-cell narrow">
						...
						<div class="h3 m-0 mt-2">{print_money($user->_data['user_monetization_balance'])}</div>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-6">
				<div class="stat-panel bg-success bg-opacity-10">
					<div class="stat-cell narrow">
						...
						<div class="h3 m-0 mt-2">{print_money($total_earnings)}</div>
					</div>
				</div>
			</div>
			<div class="col-lg-6">
				<div class="stat-panel bg-info bg-opacity-10">
					<div class="stat-cell narrow">
						...
						<div class="h3 m-0 mt-2">{print_money($this_month_earnings)}</div>
					</div>
				</div>
			</div>
		</div>
					...
					<tbody>
						{foreach $earnings as $earning}
							<tr>
								...
								<td class="bg-transparent">{print_money($earning['price'])}</td>
								<td class="bg-transparent">{print_money($earning['commission'])}</td>
								<td class="bg-transparent">{print_money($earning['earning'])}</td>
								<td class="bg-transparent">
