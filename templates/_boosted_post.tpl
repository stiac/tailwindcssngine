{* Tailwind CSS: wrapper per evidenziare i post promossi con bordi, spaziature e badge contestuale *}
<section class="boosted-post-wrapper relative rounded-2xl border border-amber-200/60 bg-amber-50/40 p-3 shadow-sm">
  <div class="absolute right-3 top-3 inline-flex items-center gap-1 rounded-full bg-amber-500/90 px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-white shadow">
