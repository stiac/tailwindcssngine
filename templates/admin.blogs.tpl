    ...
    <div class="card-body">
      ...
      <div class="mb20">
        ...
        <div class="form-text small">
          {__("Search by Blog Title, Text or Tags")}
        </div>
      </div>
      <!-- search form -->
            ...
            {if $rows}
              {foreach $rows as $row}
                <tr>
                  <td>{$row['post_id']}</td>
                  <td>
                    <a target="_blank" href="{$row['blog_author_url']}">
                      <img class="tbl-image" src="{$row['blog_author_picture']}">
                  ...
                  <td>
                    <a class="btn btn-sm btn-light" href="{$system['system_url']}/blogs/{$row['post_id']}/{$row['blog_title_url']}" target="_blank">
