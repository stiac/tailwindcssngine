...
<form class="js_ajax-forms" data-url="posts/share.php?do=publish&post_id={$post['post_id']}">
  <div class="modal-body">
    ...
    <div class="d-flex align-items-center flex-wrap gap-3 mb-3 pb-1">
      ...
      <label class="button-label m-0 px-3 py-2 flex-1" for="share_to_timeline">
      ...
      {if $system['pages_enabled'] && $pages}
        ...
        <label class="button-label m-0 px-3 py-2 flex-1" for="share_to_page">
      ...
      {if $system['groups_enabled'] && $groups}
        ...
        <label class="button-label m-0 px-3 py-2 flex-1" for="share_to_group">
      ...
      {if $system['events_enabled'] && $events}
        ...
        <label class="button-label m-0 px-3 py-2 flex-1" for="share_to_event">
