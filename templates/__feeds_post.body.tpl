						...
						{if $_post['author_id'] != $user->_data['user_id'] }
							<div class="mt-3 d-flex gap-3">
								...
								{if $system['chat_enabled'] && $_post['user_type'] == 'user'}
									<button type="button" class="btn btn-gray flex-0 js_chat-start" data-uid="{$_post['author_id']}" data-name="{$_post['post_author_name']}" data-link="{$_post['user_name']}" data-picture="{$_post['post_author_picture']}" data-product-post-id="{$_post['post_id']}" title='{__("Contact Seller")}'>
